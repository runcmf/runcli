...
use RunCli\MigrationsGenerator\Generators\SchemaGenerator;
use RunCli\MigrationsGenerator\Syntax\AddToTable;
use RunCli\MigrationsGenerator\Syntax\AddForeignKeysToTable;
use RunCli\MigrationsGenerator\Syntax\RemoveForeignKeysFromTable;
