...
class GenerateMigrationsCommand extends Command
{
  ...
  protected function configure()
  {
    ...
    $this
      ...
      ->setDescription('Generate Migrations From Exist DataBase With Eloquent ORM')
//      ->addArgument(
//        'path',
//        InputArgument::REQUIRED,
//        'Generate Migrations From Existed Eloquent DB'
//      )
//      ->addArgument(
//        'arg',
...
EOT
  ...
  {
    $output->writeln('<error>execute</error>');
